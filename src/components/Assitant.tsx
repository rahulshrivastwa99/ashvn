...
export default function Assitant() {
  ...
  const generateResponse = (userMessage: string): string => {
    ...
    const responses =
      mentalHealthResponses[category as keyof typeof mentalHealthResponses];
    ...
    if (nextQuestionIndex < assessmentQuestions[type].length) {
      ...
      if (type === "PHQ-9") {
        if (totalScore <= 4) {
          risk = "low";
          message =
            "Your PHQ-9 score indicates minimal depression symptoms. That's great! Continue with healthy habits like regular sleep, exercise, and social connections.";
        } else if (totalScore <= 9) {
          risk = "medium";
          message =
            "Your PHQ-9 score indicates mild depression symptoms. Consider speaking with a counselor and practicing self-care strategies I can teach you.";
        } else if (totalScore <= 14) {
          risk = "high";
          message =
            "Your PHQ-9 score indicates moderate depression symptoms. I strongly recommend scheduling an appointment with a mental health professional. Would you like me to help you find resources?";
        } else {
          risk = "critical";
          message =
            "Your PHQ-9 score indicates severe depression symptoms. Please seek immediate professional help. I can connect you with emergency resources if needed.";
        }
      } else {
        // GAD-7
        if (totalScore <= 4) {
          risk = "low";
          message =
            "Your GAD-7 score indicates minimal anxiety symptoms. Keep practicing relaxation techniques and maintaining healthy coping strategies.";
        } else if (totalScore <= 9) {
          risk = "medium";
          message =
            "Your GAD-7 score indicates mild anxiety symptoms. Let's work on some anxiety management techniques together.";
        } else if (totalScore <= 14) {
          risk = "high";
          message =
            "Your GAD-7 score indicates moderate anxiety symptoms. I recommend speaking with a counselor about these feelings.";
        } else {
          risk = "critical";
          message =
  ...
  const sendMessage = async () => {
    ...
    setTimeout(() => {
      ...
      if (
        inputText.toLowerCase().includes("phq") ||
        inputText.toLowerCase().includes("depression assessment")
      ) {
        startAssessment("PHQ-9");
        setIsTyping(false);
        return;
      } else if (
        inputText.toLowerCase().includes("gad") ||
        inputText.toLowerCase().includes("anxiety assessment")
      ) {
                    ...
                    <div
                      className={`mt-3 p-3 rounded-lg ${
                        message.assessment.risk === "critical"
                          ...
                          : message.assessment.risk === "medium"
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="text-xs font-medium">
                          {message.assessment.type} Score:{" "}
                          {message.assessment.score}/
